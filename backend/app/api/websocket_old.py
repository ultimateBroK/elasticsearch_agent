...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, session_id: str = None) -> str:
        ...
        await self.send_message(connection_id, {
            ...
            "message": "🔗 Connected to Elasticsearch Agent! Ask me anything about your data."
        })
    ...
    async def send_typing_indicator(self, connection_id: str, is_typing: bool = True):
...
async def handle_websocket_chat(websocket: WebSocket, session_id: str = None):
...
async def handle_chat_message(connection_id: str, message_data: dict):
    ...
    try:
        ...
        try:
            ...
            agent_result = await asyncio.wait_for(
                elasticsearch_agent.process_message(
